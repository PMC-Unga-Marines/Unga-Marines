...
export const MESSAGE_TYPES = [
  ...
  },
  {
    ...
    selector:
      '.alert, .minorannounce, .radio, .deptradio, .syndradio, .comradio, .casradio, .engradio, .medradio, .sciradio, .supradio, .alpharadio, .bravoradio, .charlieradio, .deltaradio, .zuluradio, .yankeeradio, .xrayradio, .whiskeyradio, .newscaster, .binarysay, .hivemind, .yautjaradio, .phoneradio',
  },
  {
  ...
  },
  {
    ...
    selector:
      '.warning, .xenowarning, .danger, .xenodanger, .highdanger, .xenohighdanger, .xenoannounce, .xenobanishtitleannonce, .xenobanishannonce',
  },
  {
