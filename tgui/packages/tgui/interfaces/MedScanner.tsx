...
type MedScannerData = {
  ...
  stomach_chemicals_lists: object;
  ...
  return (
    ...
    >
      <Window.Content scrollable>
        <PatientBasics />
        {has_unknown_chemicals ? <PatientUnknownChemicals /> : null}
        {has_chemicals ? <PatientChemicals /> : null}
        {has_stomach_chemicals ? <PatientStomachChemicals /> : null}
...
const PatientUnknownChemicals = () => {
  const { data } = useBackend<MedScannerData>();
  const { has_unknown_chemicals } = data;
  return (
    <Box>
      {has_unknown_chemicals ? (
...
const PatientStomachChemicals = () => {
  const { data } = useBackend<MedScannerData>();
  const { stomach_chemicals_lists } = data;
