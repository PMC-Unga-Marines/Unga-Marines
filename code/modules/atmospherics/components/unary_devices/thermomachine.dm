...
/obj/machinery/atmospherics/components/unary/thermomachine/Initialize(mapload, process, setdir)
	. = ..()
...
/obj/machinery/atmospherics/components/unary/thermomachine/freezer/on/Initialize(mapload, process, setdir)
	. = ..()
...
/obj/machinery/atmospherics/components/unary/thermomachine/freezer/on/coldroom/Initialize(mapload, process, setdir)
	. = ..()
