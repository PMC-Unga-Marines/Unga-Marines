...
/obj/machinery/atmospherics/components/unary/thermomachine/New(loc, process, setdir)
	. = ..()
...
/obj/machinery/atmospherics/components/unary/thermomachine/freezer/on/New(loc, process, setdir)
	. = ..()
...
/obj/machinery/atmospherics/components/unary/thermomachine/freezer/on/coldroom/New(loc, process, setdir)
	. = ..()
