...
/obj/item/moneybag/interact(mob/user)
	...
	if(amt_gold)
		dat += "Gold coins: [amt_gold] <A href='byond://?src=[text_ref(src)];remove=gold'>Remove one</A><br>"
	if(amt_silver)
		dat += "Silver coins: [amt_silver] <A href='byond://?src=[text_ref(src)];remove=silver'>Remove one</A><br>"
	if(amt_iron)
		dat += "Metal coins: [amt_iron] <A href='byond://?src=[text_ref(src)];remove=iron'>Remove one</A><br>"
	if(amt_diamond)
		dat += "Diamond coins: [amt_diamond] <A href='byond://?src=[text_ref(src)];remove=diamond'>Remove one</A><br>"
	if(amt_phoron)
		dat += "Phoron coins: [amt_phoron] <A href='byond://?src=[text_ref(src)];remove=phoron'>Remove one</A><br>"
	if(amt_uranium)
		dat += "Uranium coins: [amt_uranium] <A href='byond://?src=[text_ref(src)];remove=uranium'>Remove one</A><br>"
