...
GLOBAL_LIST_INIT(all_supply_groups, list("Operations", "Smartguns", "Stationary", "Weapons", "Launchers", "Explosives", "Armor", "Clothing", "Medical", "Engineering", "Supplies", "Imports", "Vehicles", "Factory"))
