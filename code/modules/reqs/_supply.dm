...
/obj/item/supplytablet/crash
	...
	desc = "A tablet for an Automated Storage and Retrieval System. This version appears to be different from the one you usually see and somehow does not require special access."
