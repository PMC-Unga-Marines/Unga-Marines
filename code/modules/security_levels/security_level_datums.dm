...
/datum/security_level/blue
	name = "blue"
	lowering_body = "Потенциальная вражеская активность на судне. Всему персоналу корабля следует сохранять бдительность и носить шлем."
	elevating_body = "Потенциальная вражеская активность на судне. Всему персоналу корабля следует сохранять бдительность и носить шлем."
...
/datum/security_level/red
	name = "red"
	lowering_body = "Обнаружена прямая угроза судну. Просьба немедленно начать подготовку к эвакуации или обороне."
	elevating_body = "Обнаружена прямая угроза судну. Просьба немедленно начать подготовку к эвакуации или обороне."
