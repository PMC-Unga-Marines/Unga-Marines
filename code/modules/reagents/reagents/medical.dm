...
/datum/reagent/mastac/on_mob_add(mob/living/live, metabolism)
...
/datum/reagent/mastac/on_mob_life(mob/living/live, metabolism)
	. = ..()
	if(volume < 5)
		live.reagents.add_reagent(/datum/reagent/mastac, 0.5)
	switch(current_cycle)
		if(1 to 40)
