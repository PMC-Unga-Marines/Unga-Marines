...
/mob/living/carbon/xenomorph/proc/update_leader_icon(makeleader = TRUE)
	...
	if(istype(xeno_caste, /datum/xeno_caste/queen) || istype(xeno_caste, /datum/xeno_caste/predalien) || istype(xeno_caste, /datum/xeno_caste/shrike) || istype(xeno_caste, /datum/xeno_caste/king))
		return
