/mob/living/carbon/xenomorph/predalien_warrior
	caste_base_type = /mob/living/carbon/xenomorph/predalien_warrior
	name = "predalien_warrior" //snowflake name
	...
	icon_state = "predalien_warrior Walking"
	wall_smash = TRUE
	pixel_x = -16
	old_x = -16
...
/mob/living/carbon/xenomorph/predalien_warrior/Initialize(mapload, mob/living/carbon/xenomorph/oldxeno, h_number)
	. = ..()
...
/mob/living/carbon/xenomorph/predalien_warrior/Stat()
	. = ..()
	if(statpanel("Game"))
		stat("Life Kills Bonus:", "[min(life_kills_total, max_bonus_life_kills)] / [max_bonus_life_kills]")

/mob/living/carbon/xenomorph/predalien_warrior/proc/announce_spawn()
	if(!loc)
		return FALSE
