...
//metal = 4 points
//silver = 8 (12 in cargo) points //used to craft osmium
//glass = 2 points
...
//cloth = 4 points
//platinum = 12 (even more in cargo) points
//copper = 4 points
...
/datum/assembly_craft/engineering/junk_platinum_convert
	...
	output = list(/obj/item/stack/sheet/mineral/copper = 3, /obj/item/stack/sheet/mineral/platinum = 1) //12 + 12
...
/datum/assembly_craft/explosives/razornade
	name = "M15 fragmentation grenade"
	input = list(/obj/item/stack/sheet/metal = 2, /obj/item/stack/sheet/mineral/copper = 3) // 8 + 12 points
...
/datum/assembly_craft/explosives/standard_recoilless_refill
	...
	input = list(/obj/item/stack/sheet/metal = 5, /obj/item/stack/gun_powder = 3) // 20 + 16 points
