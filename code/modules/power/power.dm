...
/proc/power_failure(announce = TRUE)
	...
	if(announce)
		priority_announce("В системе питания судна обнаружена аномальная активность. В качестве меры предосторожности питание должно быть отключено на неопределенный срок.", "Критический Сбой Питания", sound = 'sound/AI/poweroff.ogg')
