...
/datum/instrument/proc/calculate_samples()
	...
	for(var/i in 1 to (length(real_keys) - 1))
		...
		var/pivot = FLOOR((from_key + to_key) * 0.5, 1)			//original code was a round but I replaced it because that's effectively a floor, thanks Baystation! who knows what was intended.
