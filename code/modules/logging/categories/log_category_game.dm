...
/datum/log_category/game_hivemind
	category = LOG_CATEGORY_GAME_HIVEMIND
...
/datum/log_category/game_xooc
	category = LOG_CATEGORY_GAME_XOOC
	config_flag = /datum/config_entry/flag/log_xooc
	master_category = /datum/log_category/game
