...
/obj/item/attachable/burstfire_assembly
	...
	desc = "A mechanism re-assembly kit that allows for automatic fire, or more shots per burst if the weapon already has the ability. Increases scatter and decreases accuracy."
