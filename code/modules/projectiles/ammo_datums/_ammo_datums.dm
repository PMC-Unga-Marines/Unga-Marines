...
/datum/ammo/proc/on_hit_obj(obj/target_object, atom/movable/projectile/proj)
	return
...
/datum/ammo/proc/reflect(turf/target_turf, atom/movable/projectile/proj, scatter_variance)
