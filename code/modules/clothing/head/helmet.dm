...
/obj/item/clothing/head/helmet/space/snowman
	name = "snowman hat"
	desc = "A slightly floppy hat worn by Ded Moroz workforce, a careful look reveals a tag with the words 'Made on Mars' inside."
	icon_state = "elfhat"
...
/obj/item/clothing/head/helmet/space/dedmoroz/special
	name = "Ded Moroz hat"
	desc = "Ho ho ho. Happy New Year! Now you're all gonna die!"
