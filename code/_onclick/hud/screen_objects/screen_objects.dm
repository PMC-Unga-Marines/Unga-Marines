...
/atom/movable/screen/ammo/proc/update_hud(mob/living/user, list/ammo_type, rounds)
	...
	if(rounds <= 0)
		overlays += image('icons/mob/hud/ammo.dmi', src, "o0")
		var/image/empty_state = image('icons/mob/hud/ammo.dmi', src, ammo_type[AMMO_HUD_ICON_EMPTY])
	...
	warned = FALSE
	overlays += image('icons/mob/hud/ammo.dmi', src, "[ammo_type[AMMO_HUD_ICON_NORMAL]]")
	...
	switch(length(rounds))
		if(1)
			overlays += image('icons/mob/hud/ammo.dmi', src, "o[rounds[1]]")
		if(2)
			overlays += image('icons/mob/hud/ammo.dmi', src, "o[rounds[2]]")
			overlays += image('icons/mob/hud/ammo.dmi', src, "t[rounds[1]]")
		if(3)
			overlays += image('icons/mob/hud/ammo.dmi', src, "o[rounds[3]]")
			overlays += image('icons/mob/hud/ammo.dmi', src, "t[rounds[2]]")
			overlays += image('icons/mob/hud/ammo.dmi', src, "h[rounds[1]]")
		else //"0" is still length 1 so this means it's over 999
			overlays += image('icons/mob/hud/ammo.dmi', src, "o9")
			overlays += image('icons/mob/hud/ammo.dmi', src, "t9")
			overlays += image('icons/mob/hud/ammo.dmi', src, "h9")
