...
/atom/movable/screen/alert/status_effect/bull_direct_speed
	name = "Direct Speed Boost"
	desc = "Increased movement speed by 20%"
	icon_state = "xenobuff_generic"

/atom/movable/screen/alert/status_effect/bull_direct_health
	name = "Direct Health Boost"
	desc = "Increased maximum health by 50 points"
	icon_state = "xenobuff_generic"
