...
/datum/game_mode/hvh/announce_round_stats()
	...
	if(GLOB.round_statistics.total_human_deaths[FACTION_TERRAGOV])
		if(GLOB.round_statistics.total_human_revives[FACTION_TERRAGOV])
			tgmc_survival_stat = "[GLOB.round_statistics.total_human_revives[FACTION_TERRAGOV]] были возрождены, [(GLOB.round_statistics.total_human_revives[FACTION_TERRAGOV] / max(GLOB.round_statistics.total_human_deaths[FACTION_TERRAGOV], 1)) * 100]% соотношении возрождения и [((GLOB.round_statistics.total_humans_created[FACTION_TERRAGOV] + GLOB.round_statistics.total_human_revives[FACTION_TERRAGOV] - GLOB.round_statistics.total_human_deaths[FACTION_TERRAGOV]) / GLOB.round_statistics.total_humans_created[FACTION_TERRAGOV]) * 100]% соотношении выживания."
		else
			tgmc_survival_stat = "Ни один из них не был возрожден. [((GLOB.round_statistics.total_humans_created[FACTION_TERRAGOV] - GLOB.round_statistics.total_human_deaths[FACTION_TERRAGOV]) / GLOB.round_statistics.total_humans_created[FACTION_TERRAGOV]) * 100]% соотношении выживания."
	if(GLOB.round_statistics.total_human_deaths[FACTION_SOM])
		if(GLOB.round_statistics.total_human_revives[FACTION_SOM])
			som_survival_stat = "[GLOB.round_statistics.total_human_revives[FACTION_SOM]] были возрождены, [(GLOB.round_statistics.total_human_revives[FACTION_SOM] / max(GLOB.round_statistics.total_human_deaths[FACTION_SOM], 1)) * 100]% соотношении возрождения и [((GLOB.round_statistics.total_humans_created[FACTION_SOM] + GLOB.round_statistics.total_human_revives[FACTION_SOM] - GLOB.round_statistics.total_human_deaths[FACTION_SOM]) / GLOB.round_statistics.total_humans_created[FACTION_SOM]) * 100]% соотношении выживания."
		else
			som_survival_stat = "Ни один из них не был возрожден. [((GLOB.round_statistics.total_humans_created[FACTION_SOM] - GLOB.round_statistics.total_human_deaths[FACTION_SOM]) / GLOB.round_statistics.total_humans_created[FACTION_SOM]) * 100]% соотношении выживания."
