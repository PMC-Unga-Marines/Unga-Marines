GLOBAL_LIST_INIT(bitfields, list(
	...
	"reciever_flags" = list(
		...
		"AMMO_RECIEVER_REQUIRES_CYCLE_FIRST_ROUND" = AMMO_RECIEVER_REQUIRES_CYCLE_FIRST_ROUND
	),
	"be_special" = list(
		"BE_ALIEN" = BE_ALIEN,
		"BE_QUEEN" = BE_QUEEN,
	...
	"scuttle_flags" = list(
		"EVACUATION_DENY_flags" = EVACUATION_DENY_flags,
		"SELF_DESTRUCT_DENY_flags" = SELF_DESTRUCT_DENY_flags,
		"SDEVAC_TIMELOCK_flags" = SDEVAC_TIMELOCK_flags
	),
	"buckle_flags" = list(
	...
	"resistance_flags" = list(
		...
		"BLOCK_PASSTHROUGH_PROJECTILES" = BLOCK_PASSTHROUGH_PROJECTILES,
	),
