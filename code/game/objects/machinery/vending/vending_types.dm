...
/obj/machinery/vending/nanomed/tadpolemed
	...
	products = list(
		...
		"Heal Pack" = list(
			/obj/item/stack/medical/heal_pack/gauze = 3,
			/obj/item/stack/medical/heal_pack/ointment = 3,
			/obj/item/stack/medical/heal_pack/advanced/bruise_pack = 3,
			/obj/item/stack/medical/heal_pack/advanced/burn_pack = 3,
			/obj/item/healthanalyzer = 1,
			/obj/item/stack/medical/splint = 2,
		),
	)
