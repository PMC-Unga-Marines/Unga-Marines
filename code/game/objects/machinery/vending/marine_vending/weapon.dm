/obj/machinery/vending/weapon
	...
	products = list(
		...
		"Модули" = list(
			...
			/obj/item/attachable/foldable/ar18stock = -1,
			/obj/item/attachable/stock/ar12stock = -1,
			/obj/item/attachable/stock/ar21stock = -1,
			/obj/item/attachable/stock/t42stock = -1,
