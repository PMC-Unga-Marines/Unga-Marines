/obj/machinery/vending/valhalla_req
	...
	products = list(
		...
		"Modules" = list(
			...
			/obj/item/armor_module/module/tyr_head/mark2 = -1,
		...
		"Implants" = list(
			...
			/obj/item/implanter/skill/pistols = -1,
			/obj/item/implanter/skill/smgs = -1,
			/obj/item/implanter/skill/rifles = -1,
			/obj/item/implanter/skill/shotguns = -1,
