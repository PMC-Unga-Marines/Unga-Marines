/obj/machinery/vending/weapon
	...
	products = list(
		...
		"Melee" = list(
			...
			/obj/item/attachable/bayonetknife = 25,
			/obj/item/stack/throwing_knife = 50,
			/obj/item/storage/belt/knifepouch = 5,
			/obj/item/storage/holster/blade/tomahawk/full = 10,
			/obj/item/storage/holster/blade/machete/full = 10,
			/obj/item/storage/holster/blade/harvester/full = 10,
			/obj/item/weapon/twohanded/spear/tactical = 10,
			/obj/item/weapon/twohanded/spear/tactical/harvester = 10,
			/obj/item/weapon/twohanded/glaive/harvester = 10,
