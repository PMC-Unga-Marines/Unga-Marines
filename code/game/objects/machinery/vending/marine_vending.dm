...
/obj/machinery/vending/weapon/valhalla
	...
	products = list(
		...
		"Гранаты" = list(
			...
			/obj/item/explosive/grenade/sectoid = -1,
			...
			/obj/item/explosive/grenade/chem_grenade/incendiary = -1,
			/obj/item/explosive/grenade/chem_grenade/teargas = -1,
		),
		"Снаряжение, тарпы и клоаки" = list(
