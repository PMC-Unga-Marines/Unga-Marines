...
/obj/effect/landmark/corpsespawner/proc/create_mob()
	...
	SSblackbox.record_feedback(FEEDBACK_TALLY, "round_statistics", -1, "total_humans_created[victim.faction]")
	...
	SSblackbox.record_feedback(FEEDBACK_TALLY, "round_statistics", -1, "total_human_deaths[victim.faction]")
