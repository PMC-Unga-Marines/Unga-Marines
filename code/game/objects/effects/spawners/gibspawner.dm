...
/obj/effect/spawner/gibspawner/proc/Gib(atom/location, mapload)
...
/obj/effect/spawner/gibspawner/human/Initialize(mapload)
...
/obj/effect/spawner/gibspawner/robot/Initialize(mapload)
