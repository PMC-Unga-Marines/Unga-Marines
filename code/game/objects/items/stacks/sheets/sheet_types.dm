...
/obj/item/stack/sheet/metal/select_radial(mob/user)
	...
	switch (choice)
		if("recipes")
			return TRUE
		if("metal barricade")
			create_object(user, new/datum/stack_recipe("metal barricade", /obj/structure/barricade/metal, 4, time = 6 SECONDS, crafting_flags = CRAFT_CHECK_DIRECTION | CRAFT_ON_SOLID_GROUND, skill_req = SKILL_CONSTRUCTION_METAL), 1)
		if("folding metal barricade")
			create_object(user, new/datum/stack_recipe("folding metal barricade", /obj/structure/barricade/plasteel/metal, 6, time = 10 SECONDS, crafting_flags = CRAFT_CHECK_DIRECTION | CRAFT_ON_SOLID_GROUND, skill_req = SKILL_CONSTRUCTION_METAL), 1)
		if("barbedwire")
...
GLOBAL_LIST_INIT(plasteel_recipes, list ( \
	new/datum/stack_recipe("plasteel barricade", /obj/structure/barricade/metal/plasteel, 4, time = 6 SECONDS, crafting_flags = CRAFT_CHECK_DIRECTION | CRAFT_ON_SOLID_GROUND, skill_req = SKILL_CONSTRUCTION_PLASTEEL), \
	new/datum/stack_recipe("plasteel folding barricade", /obj/structure/barricade/plasteel, 6, time = 10 SECONDS, crafting_flags = CRAFT_CHECK_DIRECTION | CRAFT_ON_SOLID_GROUND, skill_req = SKILL_CONSTRUCTION_PLASTEEL), \
	null, \
	))
