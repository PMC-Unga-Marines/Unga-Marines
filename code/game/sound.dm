...
/proc/get_sfx(S)
	...
	switch(S)
		...
		if("alien_footstep_large")
			S = pick('sound/effects/alien/footstep_large1.ogg','sound/effects/alien/footstep_large2.ogg','sound/effects/alien/footstep_large3.ogg')
		if("alien_charge")
			S = pick('sound/effects/alien/footstep_charge1.ogg','sound/effects/alien/footstep_charge2.ogg','sound/effects/alien/footstep_charge3.ogg')
