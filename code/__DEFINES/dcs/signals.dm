...
// /turf signals
#define COMSIG_TURF_CHANGE "turf_change"						//from base of turf/change_turf(): (path, list/new_baseturfs, flags, list/transferring_comps)
...
#define COMSIG_HUMAN_PRE_APPLY_DAMAGE "human_pre_apply_damage" //from human damage receiving procs (damage, damagetype, def_zone, blocked, sharp, edge, updating_health, penetration, amount_mod)
