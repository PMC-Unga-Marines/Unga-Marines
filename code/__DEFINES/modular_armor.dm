...
#define CUSTOM_COLOR "Custom Color"
...
#define CUSTOM_COLOR_ALLOWED (1<<1)
#define PRESET_COLORS_ALLOWED (1<<2)
#define ICON_STATE_VARIANTS_ALLOWED (1<<3)
//RUTGMC ADDITION
#define HAIR_CONCEALING_CHANGE_ALLOWED (1<<4)
