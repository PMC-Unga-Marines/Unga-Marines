...
#define MODE_NO_PERMANENT_WOUNDS (1<<11)
#define MODE_SILOS_SPAWN_MINIONS (1<<12)
#define MODE_ALLOW_XENO_QUICKBUILD (1<<13)
#define MODE_DISALLOW_RAILGUN (1<<14)
#define MODE_SILO_NO_LARVA (1<<15)
