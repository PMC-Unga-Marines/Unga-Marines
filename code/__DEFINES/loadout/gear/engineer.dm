GLOBAL_LIST_INIT(engineer_gear_listed_products, list(
	...
	/obj/item/implanter/skill/pistols = list(CAT_ENGSUP, "Pistol skills implanter", 25, "cyan2"),
	/obj/item/implanter/skill/smgs = list(CAT_ENGSUP, "SMG skills implanter", 25, "cyan2"),
	/obj/item/implanter/skill/rifles = list(CAT_ENGSUP, "Rifle skills implanter", 25, "cyan2"),
	/obj/item/implanter/skill/shotguns = list(CAT_ENGSUP, "Shotgun skills implanter", 25, "cyan2"),
