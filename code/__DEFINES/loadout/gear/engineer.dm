GLOBAL_LIST_INIT(engineer_gear_listed_products, list(
	...
	/obj/structure/closet/crate/uav_crate = list(CAT_ENGSUP, "Iguana Unmanned Vehicle", 40, "blue"),
	/obj/structure/closet/crate/uav_crate/medium = list(CAT_ENGSUP, "Gecko Unmanned Vehicle", 45, "blue"),
	/obj/structure/closet/crate/uav_crate/heavy = list(CAT_ENGSUP, "Komodo Unmanned Vehicle", 55, "blue"),
