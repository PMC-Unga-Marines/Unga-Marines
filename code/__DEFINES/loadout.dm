...
GLOBAL_LIST_INIT(marine_gear_listed_products, list(
	...
	/obj/item/explosive/grenade/smokebomb/drain = list(CAT_MARINE, "M40-T smoke grenade", 10, "orange3"),
	/obj/item/explosive/grenade/sticky/cloaker/tangle = list(CAT_MARINE, "M45-T tanglefoot grenade", 10, "orange3"),
