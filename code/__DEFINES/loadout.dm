...
GLOBAL_LIST_INIT(marine_gear_listed_products, list(
	/obj/item/implanter/implantator/combat/firearms = list(CAT_MARINE, "Aiming support implanter", 40, "cyan2"),
	/obj/item/implanter/implantator/combat/melee = list(CAT_MARINE, "Close combat codex implanter", 30, "cyan2"),
