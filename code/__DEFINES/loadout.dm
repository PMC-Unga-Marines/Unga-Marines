...
GLOBAL_LIST_INIT(marine_gear_listed_products, list(
	/obj/item/implanter/implantator/combat/firearms = list(CAT_MARINE, "Aiming support implanter", 45, "cyan2"),
	/obj/item/implanter/implantator/combat/melee = list(CAT_MARINE, "Close combat codex implanter", 45, "cyan2"),
	/obj/item/implanter/implantator/codex/medical = list(CAT_MARINE, "Medtech implanter", 45, "cyan2"),
	/obj/item/implanter/implantator/codex/engineer = list(CAT_MARINE, "Construction support system implanter", 40, "cyan2"),
...
GLOBAL_LIST_INIT(engineer_gear_listed_products, list(
	...
	/obj/item/implanter/implantator/combat/firearms = list(CAT_ENGSUP, "Aiming support implanter", 45, "cyan2"),
	/obj/item/implanter/implantator/combat/melee = list(CAT_ENGSUP, "Close combat codex implanter", 45, "cyan2"),
	/obj/item/implanter/implantator/codex/engineer = list(CAT_ENGSUP, "Construction support system implanter", 40, "cyan2"),
...
GLOBAL_LIST_INIT(medic_gear_listed_products, list(
	...
	/obj/item/implanter/implantator/combat/firearms = list(CAT_MEDSUP, "Aiming support implanter", 45, "cyan2"),
	/obj/item/implanter/implantator/combat/melee = list(CAT_MEDSUP, "Close combat codex implanter", 45, "cyan2"),
	/obj/item/implanter/implantator/codex/medical = list(CAT_MEDSUP, "Medtech implanter", 45, "cyan2"),
	/obj/item/implanter/implantator/codex/surgery = list(CAT_MEDSUP, "Surgery assisting system implanter", 45, "cyan2"),
...
GLOBAL_LIST_INIT(leader_gear_listed_products, list(
	...
	/obj/item/implanter/implantator/combat/firearms = list(CAT_LEDSUP, "Aiming support implanter", 45, "cyan2"),
	/obj/item/implanter/implantator/combat/melee = list(CAT_LEDSUP, "Close combat codex implanter", 45, "cyan2"),
...
GLOBAL_LIST_INIT(commander_gear_listed_products, list(
	...
	/obj/item/implanter/implantator/combat/firearms = list(CAT_FCSUP, "Aiming support implanter", 30, "cyan2"),
	/obj/item/implanter/implantator/combat/melee = list(CAT_FCSUP, "Close combat codex implanter", 30, "cyan2"),
