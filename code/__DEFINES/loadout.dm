...
GLOBAL_LIST_INIT(engineer_gear_listed_products, list(
	...
	/obj/item/weapon/gun/agls37 = list(CAT_ENGSUP, "AGLS-37", 50, "blue"),
	/obj/item/weapon/gun/flamer/big_flamer/marinestandard = list(CAT_ENGSUP, "FL-84 flamethrower", 30, "blue"),
	/obj/item/ammo_magazine/flamer_tank/large/G = list(CAT_ENGSUP, "Green-gel flamethrower tank", 10, "blue"),
