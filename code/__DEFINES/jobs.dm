...
GLOBAL_LIST_INIT(jobs_medical, list(CHIEF_MEDICAL_OFFICER, MEDICAL_DOCTOR, FIELD_RESEARCHER, SQUAD_CORPSMAN))
...
MEDICAL_DOCTOR, FIELD_RESEARCHER, SQUAD_LEADER, SQUAD_SMARTGUNNER, SQUAD_CORPSMAN, SQUAD_ENGINEER, SQUAD_MARINE, SQUAD_ROBOT))
...
#define LARVA_POINTS_REGULAR 3.40 //3 marinas give more than 10 points so that the lavra points are completely filled and there is no situation where there are 9.75 lavra points on the low pop
